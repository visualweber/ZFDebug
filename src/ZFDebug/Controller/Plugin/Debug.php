...
class ZFDebug_Controller_Plugin_Debug extends Zend_Controller_Plugin_Abstract {
    ...
    protected function _getVersionPanel() {
        $panel = '<h4>ZFDebug v' . $this->_version . '</h4>' .
                '<p>©2008-2016 <a href="http://visualweber.com">Visual Weber Vietnam</a> & <a href="http://www.visualweber.com">Visual Weber Team</a></p>' .
                '<p>The project is hosted at <a href="https://github.com/visualweber/zfdebug">https://github.com/visualweber/zfdebug</a> and released under the BSD License<br />' .
                '</p>';
